...
%>
	<tr> 
    <td align="center"><font color="#FFFFFF">查看影片</font></td>
  </tr>
  <tr> 
    <td valign="top" bgcolor="#FFFFFF"><br> 
      ...
      <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="799AE1">
        <tr height="20" bgcolor="#FFFFFF" align="center">
          ...
          <td width="74" height="20"><font color="#FF0000">影片名称</font></td>
          <td height="20" colspan="3"><%=rs("mingcheng")%></td>
        </tr>
        <tr height="20" bgcolor="#FFFFFF" align="center">
          <td><font color="#FF0000">上架日期</font></td>
          <td><%=rs("riqi")%></td>
          <td><font color="#FF0000">影片等级</font></td>
        ...
        <tr height="20" bgcolor="#FFFFFF" align="center">
          <td><font color="#FF0000">影片简介</font></td>
          <td colspan="3"><div align="left"><%=rs("jianjie")%></div></td>
        </tr>
        <tr height="20" bgcolor="#FFFFFF" align="center">
          <td><font color="#FF0000">影片编号</font></td>
        ...
        <tr height="20" bgcolor="#FFFFFF" align="center">
          <td height="126"><font color="#FF0000">影片备注</font></td>
